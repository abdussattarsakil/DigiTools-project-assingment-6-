        ...
        <div className="mb-20">
            <div className="navbar bg-base-100 shadow-sm">
                <div className="navbar-start lg:justify-center">
                    ...
                    <h1 className="bg-linear-to-r/hsl from-blue-500 to-purple-500 bg-clip-text text-transparent text-3xl font-bold">DigiTools</h1>
                </div>
                ...
                <div className="navbar-end gap-5 lg:justify-center">
