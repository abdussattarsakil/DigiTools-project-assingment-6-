            ...
            <div className="">
                <div className="md:flex md:gap-5 md:justify-center text-center">
                    <div className="shadow-xl rounded-xl w-80 p-5 space-y-3">
                        <div className="relative "><p className="absolute top-0 right-0 p-1 rounded-full bg-purple-400">01</p></div>
                    ...
                    <div className="shadow-xl rounded-xl w-80 p-5 space-y-3">
                        <div className="relative "><p className="absolute top-0 right-0 p-1 rounded-full bg-purple-400">02</p></div>
                    ...
                    <div className="shadow-xl rounded-xl w-80 p-5 space-y-3">
                        <div className="relative "><p className="absolute top-0 right-0 p-1 rounded-full bg-purple-400">03</p></div>
